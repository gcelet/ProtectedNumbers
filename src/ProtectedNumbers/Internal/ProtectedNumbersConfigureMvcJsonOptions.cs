...
/// <summary>
/// Configures ASP.NET Core Mvc JSON options to include a converter that exposes the application's service provider
/// to System.Text.Json, enabling dependency resolution during serialization/deserialization.
/// </summary>
internal class ProtectedNumbersConfigureMvcJsonOptions : IConfigureOptions<Microsoft.AspNetCore.Mvc.JsonOptions>
{
  /// <summary>
  ...
  public ProtectedNumbersConfigureMvcJsonOptions(IServiceProvider serviceProvider,
  ...
  {
    options.JsonSerializerOptions.TryAddServiceProvider(ServiceProvider, HttpContextAccessor);
  }
}
